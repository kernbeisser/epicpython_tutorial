...
def some_func():
    ...
    5 % 2 # modulo (this means finding out the remainder after division
    ...
    #  Highest priority: raising to a power; Medium priority: division,
    #  multiplication and modulo; Low priority: addition and subtraction

    #  1st: 5 ** 2, second: / then *, third - ; result is 90.0
    100 - 5 ** 2 / 5 * 2
