...
def some_func():
    ...
    def my_first_function(x, y): # defining a function that takes two parameters
        sum = x + y
        # this statement is used to exit a function and return
    ...
    # result is 3; rule: positional arguments always before keyword arguments!
    ...
    global my_var
    # "importing" a variable in the global namespace to the local namespace of a function
